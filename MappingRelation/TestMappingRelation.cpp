...
int main()
{
    ...
    */
    ...
    MappingRelation <string, string> temp;
    temp.add_element("France","Antoine Griezmann");
    temp.add_element("Antoine Griezmann","France");
    temp.add_element("Germany","Joshua Kimmich");
    temp.add_element("Argentina","Buenos Aires");
    ...
    */
    ...
    auto com = nations.combination(temp);
    cout << "Testing combination:" << endl;
    cout << "R1 = " << nations << "R2 = "<< temp << endl;
    cout << "R1oR2 = "<< com << endl;
    /* Should be printed
     * { (Thomas Muller, Joshua Kimmich), (Lionel Messi, Buenos Aires), (Joshua Kimmich, Joshua Kimmich), (Antoine Griezmann, Antoine Griezmann) }
     */
